    ...
    <center>
        <div class="container-fluid">
            <div class="card col-lg-4">
                <div class="p-4">
                    <form method="post" action="{{ url('/tunjangan/tambah-proses') }}">
                        @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control money @error('tunjangan_makan') is-invalid @enderror" id="tunjangan_makan" name="tunjangan_makan" autofocus value="{{ old('tunjangan_makan') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control money @error('tunjangan_transport') is-invalid @enderror" id="tunjangan_transport" name="tunjangan_transport" autofocus value="{{ old('tunjangan_transport') }}">
