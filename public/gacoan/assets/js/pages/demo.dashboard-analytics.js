  ...
  (e.prototype.initCharts = function () {
    ...
    for (
      var e = new Date(),
        ...
        t = ["#16a7e9", "#47ad77", "#fa5c7c", "#ffbc00"],
        a = s("#sessions-overview").data("colors"),
        e = {
          chart: { height: 240, type: "area" },
    ...
    (t = ["#16a7e9", "#47ad77", "#fa5c7c", "#ffbc00"]),
      ...
      (e = {
        chart: { height: 216, type: "bar", stacked: !0 },
        plotOptions: {
          bar: {
            horizontal: !1,
            endingShape: "rounded",
      ...
      (e = {
        ...
        colors: (t = (a = s("#sessions-browser").data("colors"))
          ? a.split(",")
          : t),
        yaxis: {
          labels: {
      ...
      (t = ["#16a7e9", "#47ad77", "#fa5c7c", "#ffbc00"]),
      (e = {
        chart: { height: 332, type: "bar" },
        plotOptions: { bar: { horizontal: !0 } },
        colors: (t = (a = s("#country-chart").data("colors"))
          ? a.split(",")
          : t),
        dataLabels: { enabled: !1 },
        series: [
      ...
      (e = {
        ...
        colors: (t = (a = s("#campaign-sent-chart").data("colors"))
          ? a.split(",")
          : t),
      ...
      (e = {
        ...
        markers: { size: 0 },
        colors: (t = (a = s("#new-leads-chart").data("colors"))
          ? a.split(",")
          : t),
        tooltip: {
          fixed: { enabled: !1 },
    ...
    new ApexCharts(document.querySelector("#new-leads-chart"), e).render();
  }),
