...
var barData = {
    ...
    datasets: [{
        ...
        highlightStroke: EnzoAdminConfig.primary ,
        data: [35, 59, 80, 81, 56, 55, 40]
    }, {
        label: "My Second dataset",
        fillColor: "rgba(255, 206, 0, 0.4)",
        strokeColor: EnzoAdminConfig.secondary ,
        highlightFill: "rgba(255, 206, 0, 0.6)",
        highlightStroke: EnzoAdminConfig.secondary,
...
var polarData = [
    {
        ...
        highlight:EnzoAdminConfig.primary,
        label: "Yellow"
    }, {
        value:50,
        color:"#f8d62b",
        ...
        value: 120,
        color: EnzoAdminConfig.secondary ,
        highlight: EnzoAdminConfig.secondary ,
        label: "Dark Grey"
    }
];
var polarOptions = {
...
var lineGraphData = {
    ...
    datasets: [{
        label: "My First dataset",
        fillColor: "rgba(62, 95, 206, 0.3",
        strokeColor: EnzoAdminConfig.primary ,
        pointColor: EnzoAdminConfig.primary ,
        ...
        label:"My Second dataset",
        fillColor:"rgba(255, 206, 0, 0.3)",
        strokeColor:EnzoAdminConfig.secondary ,
        pointColor:EnzoAdminConfig.secondary ,
        pointStrokeColor:"#fff",
        pointHighlightFill:"#000",
        pointHighlightStroke: EnzoAdminConfig.secondary,
        data:[28, 48, 40, 19, 86, 27, 90]
    }]
};
...
var radarData = {
    ...
    datasets: [{
        label: "My First dataset",
        fillColor: "rgba(92, 95, 206, 0.4)",
        strokeColor: EnzoAdminConfig.primary,
        pointColor: EnzoAdminConfig.primary,
        pointStrokeColor: EnzoAdminConfig.primary,
        pointHighlightFill: EnzoAdminConfig.primary ,
        pointHighlightStroke: "rgba(255, 206, 0, 0.4)",
        data: [12, 3, 5, 18, 7]
    }]
};
var radarOptions = {
...
var myLineChart = {
    ...
    datasets: [{
        fillColor:"rgba(62, 95, 206, 0.2)",
        strokeColor:EnzoAdminConfig.primary  ,
        pointColor: EnzoAdminConfig.primary ,
        data: [10, 20, 40, 30, 0, 20, 10, 30, 10]
    },{
        fillColor: "rgba(255, 206, 0, 0.2)",
        strokeColor: EnzoAdminConfig.secondary ,
        pointColor: EnzoAdminConfig.secondary ,
        data: [20, 40, 10, 20, 40, 30, 40, 10, 20]
    }, {
        fillColor:" rgba(97, 174, 65, 0.2)",
        strokeColor:EnzoAdminConfig.primary ,
        pointColor:EnzoAdminConfig.primary ,
