        ...
        function plotAccordingToChoices() {
            ...
            if (data.length > 0) {
                $.plot("#toggling-series-flot", data, {
                    ...
                    colors: [EnzoAdminConfig.primary, "#f8d62b" ,"#a927f9" ,"#51bb25" , EnzoAdminConfig.secondary , "#dc3545" ,"#f8d62b"]
...
$(function() {
    ...
    var data4_errors = [0.1, 0.4, 0.2];
        ...
        var data = [
            {color: EnzoAdminConfig.secondary , points: data1_points, data: data1, label: "data1"},
            {color: EnzoAdminConfig.primary,  points: data2_points, data: data2, label: "data2"},
            {color: EnzoAdminConfig.secondary, lines: {show: true}, points: data3_points, data: data3, label: "data3"},
            {color: EnzoAdminConfig.primary, bars: {show: true, align: "center", barWidth: 0.25}, data: data4, label: "data4"},
            {color: EnzoAdminConfig.secondary, points: data3_points, data: data4_errors}
            ];
...
$(function() {
    ...
    $.plot('#default-pie-flot-chart', data, {
        ...
        colors: [ EnzoAdminConfig.primary , "#51bb25" ,"#f8d62b" ,"#a927f9" ,"#dc3545", "#6c757d" , EnzoAdminConfig.secondary ]
    });
