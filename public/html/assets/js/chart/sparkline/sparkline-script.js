(function($) {
    ...
    setTimeout(function(){
        $("#line-chart-sparkline").sparkline([5, 10, 20, 14, 17, 21, 20, 10, 4, 13,0, 10, 30, 40, 10, 15, 20], {
            ...
            lineColor: EnzoAdminConfig.primary,
            fillColor: 'rgba(62, 95, 206, 0.40)',
            highlightLineColor: EnzoAdminConfig.primary,
            highlightSpotColor: EnzoAdminConfig.primary,
            targetColor: EnzoAdminConfig.primary,
            performanceColor: EnzoAdminConfig.primary,
            boxFillColor: EnzoAdminConfig.primary,
            medianColor: EnzoAdminConfig.primary,
            minSpotColor: EnzoAdminConfig.primary
        });
    });
    ...
    $("#custom-line-chart").sparkline([5, 30, 27, 35, 30, 50, 70], {
        ...
        tooltipClassname: 'chart-sparkline',
        chartRangeMax: '50',
        lineColor: EnzoAdminConfig.secondary,
...
var sparkline_chart = {
  init: function() {
    setTimeout(function(){
        ...
        height: '100%',
        tooltipClassname: 'chart-sparkline',
        barColor: EnzoAdminConfig.primary
    }), $("#pie-sparkline-chart").sparkline([1.5, 1, 1, 0.5], {
        type: 'pie',
        width: '100%',
        height: '100%',
        sliceColors: ['#51bb25','#f8d62b', EnzoAdminConfig.secondary , EnzoAdminConfig.primary ],
        tooltipClassname: 'chart-sparkline'
    });
    }
};
