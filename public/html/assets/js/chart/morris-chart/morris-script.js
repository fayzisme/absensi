...
var morris_chart = {
    init: function() {
        Morris.Area({
            ...
            ykeys: ['y', 'z'],
            labels: ['Y', 'Z'],
            lineColors: [EnzoAdminConfig.secondary , EnzoAdminConfig.primary ],
        }), Morris.Line({
            ...
            xkey: "y",
            ykeys: ["a", "b"],
            lineColors: [EnzoAdminConfig.primary , EnzoAdminConfig.secondary ],
            ...
            xkey: "x",
            ykeys: ["y", "z", "a"],
            barColors: [EnzoAdminConfig.primary , EnzoAdminConfig.secondary ,"#51bb25"],
            labels: ["Y", "Z", "A"]
        }), Morris.Bar({
            ...
            ykeys: ["y"],
            labels: ["Y"],
            barColors: [EnzoAdminConfig.primary]
        }), $(function() {
            var b = [{
                period: "2012-10-01",
                licensed: 5000,
            ...
            Morris.Bar({
                ...
                data: b,
                barColors: [EnzoAdminConfig.primary , EnzoAdminConfig.secondary ],
                xkey: "period",
            ...
            window.m = Morris.Line({
                ...
                labels: ["sin(x)"],
                parseTime: !1,
                lineColors: [EnzoAdminConfig.primary],
            ...
            Morris.Donut({
                ...
                labelColor: "#999999",
                colors: [EnzoAdminConfig.primary , EnzoAdminConfig.secondary ,"#f8d62b" ,"#51bb25" ,"rgba(248, 214, 43, 1)", "#51bb25" ,"#f8d62b"],
            ...
            Morris.Bar({
                ...
                ykeys: ["y", "z", "a"],
                labels: ["A", "Y", "Z"],
                barColors: [EnzoAdminConfig.primary , EnzoAdminConfig.secondary ,"#51bb25" ,"#f8d62b" ,"#a927f9", EnzoAdminConfig.secondary , EnzoAdminConfig.primary ],
                stacked: !0
            });
        });
    }
