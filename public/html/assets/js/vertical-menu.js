    ...
    $.extend($.SmartMenus, {
        ...
        prototype: {
            init: function (refresh) {
                ...
                if (this.opts.markCurrentItem) {
                    var reDefaultDoc = /(index|default)\.[^#\?\/]*/i,
                        reHash = /#.*/,
                        locHref = window.location.href.replace(
                            reDefaultDoc,
                            ""
                        ),
            ...
            destroy: function (refresh) {
                ...
                this.$root
                    ...
                    .each(function () {
                        var $this = $(this);
                        if (
                            $this.attr("id").indexOf(self.accessIdPrefix) == 0
                        ) {
                            $this.removeAttr("id");
                        }
                    })
            ...
            itemActivate: function ($a, hideDeeperSubs) {
                ...
                if (
                    ...
                    (!this.activatedItems[level - 2] ||
                        this.activatedItems[level - 2][0] !=
                            $ul.dataSM("parent-a")[0])
                ) {
                    var self = this;
                    $(
                        $ul
                ...
                if (
                    this.$root.triggerHandler("activate.smapi", $a[0]) === false
                ) {
                    return;
                }
            ...
            itemClick: function (e) {
                ...
                if ($sub) {
                    var subArrowClicked = $(e.target).is(".sub-arrow"),
                        ...
                        behaviorToggle = /toggle$/.test(
                            this.opts.collapsibleBehavior
                        ),
                        behaviorLink = /link$/.test(
                            this.opts.collapsibleBehavior
                        ),
                    ...
                    if (!$sub.is(":visible")) {
                        ...
                        collapsible &&
                        (behaviorToggle || subArrowClicked)
                    ) {
                        this.itemActivate($a, behaviorAccordion);
                        this.menuHide($sub);
                        if (behaviorToggle) {
            ...
            menuHide: function ($sub) {
                if (
                    this.$root.triggerHandler("beforehide.smapi", $sub[0]) ===
                    false
                ) {
                    return;
                }
                ...
                if ($sub.css("display") != "none") {
                    ...
                    if (this.isCollapsible()) {
                        if (canAnimate && this.opts.collapsibleHideFunction) {
                            ...
                            $sub.hide(
                                this.opts.collapsibleHideDuration,
                                complete
                            );
                        }
                    } else {
                    ...
                    this.visibleSubMenus.splice(
                        $.inArray($sub, this.visibleSubMenus),
                        1
                    );
            ...
            menuInit: function ($ul) {
                if (!$ul.dataSM("in-mega")) {
                    ...
                    // accessibility
                    var aId =
                            $a.attr("id") || this.accessIdPrefix + ++this.idInc,
                        ulId =
                            $ul.attr("id") ||
                    ...
                    if (
                        ...
                        $sub.dataSM("scroll", {
                            ...
                            .css({
                                ...
                                marginLeft:
                                    x +
                                    (parseInt($sub.css("border-left-width")) ||
                                        0),
                                width:
                                    subW -
                                    (parseInt($sub.css("border-left-width")) ||
                                        0) -
                                    (parseInt($sub.css("border-right-width")) ||
                                        0),
                                zIndex: $sub.css("z-index"),
                            })
                            .eq(
                                horizontalParent &&
                                    this.opts.bottomToTopSubMenus
                                    ? 0
                                    : 1
                            )
                            .show();
            ...
            menuScroll: function ($sub, once, step) {
                ...
                if (data.y == end) {
                    ...
                    if (
                        ...
                        data.step < this.opts.scrollStep
                    ) {
                        data.step += 0.2;
                    }
                    var self = this;
                ...
                if (isTouchEvent(e)) {
                    ...
                    if (this.getClosestMenu(touchPoint.target) == $sub[0]) {
                        ...
                        if (/(start|down)$/i.test(e.type)) {
                            ...
                            var prevY =
                                data.touchY !== undefined
                                    ? data.touchY
                                    : data.touchStartY;
                            if (
                                prevY !== undefined &&
                                prevY != touchPoint.pageY
                            ) {
                                this.$touchScrollingSub = $sub;
                                ...
                                this.menuScroll(
                                    $sub,
                                    true,
                                    Math.abs(touchPoint.pageY - prevY)
                                );
                            }
                            e.preventDefault();
                        } else {
            ...
            menuShow: function ($sub) {
                ...
                if (
                    this.$root.triggerHandler("beforeshow.smapi", $sub[0]) ===
                    false
                ) {
                    return;
                }
                ...
                if (!$sub.is(":visible")) {
                    ...
                    if (collapsible) {
                        if (canAnimate && this.opts.collapsibleShowFunction) {
                            ...
                            $sub.show(
                                this.opts.collapsibleShowDuration,
                                complete
                            );
                        }
                    } else {
